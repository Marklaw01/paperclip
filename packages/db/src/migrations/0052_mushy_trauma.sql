...
ALTER TABLE "issues" ADD COLUMN IF NOT EXISTS "execution_state" jsonb;--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "issue_execution_decisions_company_issue_idx" ON "issue_execution_decisions" USING btree ("company_id","issue_id");--> statement-breakpoint

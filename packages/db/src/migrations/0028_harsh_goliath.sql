...
CREATE UNIQUE INDEX IF NOT EXISTS "document_revisions_document_revision_uq" ON "document_revisions" USING btree ("document_id","revision_number");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "document_revisions_company_document_created_idx" ON "document_revisions" USING btree ("company_id","document_id","created_at");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "documents_company_updated_idx" ON "documents" USING btree ("company_id","updated_at");--> statement-breakpoint
...
CREATE UNIQUE INDEX IF NOT EXISTS "issue_documents_company_issue_key_uq" ON "issue_documents" USING btree ("company_id","issue_id","key");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "issue_documents_document_uq" ON "issue_documents" USING btree ("document_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "issue_documents_company_issue_updated_idx" ON "issue_documents" USING btree ("company_id","issue_id","updated_at");

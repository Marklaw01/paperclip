...
CREATE UNIQUE INDEX IF NOT EXISTS "assets_company_object_key_uq" ON "assets" USING btree ("company_id","object_key");--> statement-breakpoint
...
CREATE UNIQUE INDEX IF NOT EXISTS "issue_attachments_asset_uq" ON "issue_attachments" USING btree ("asset_id");

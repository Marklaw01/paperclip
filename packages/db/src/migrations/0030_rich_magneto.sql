...
CREATE UNIQUE INDEX IF NOT EXISTS "company_logos_company_uq" ON "company_logos" USING btree ("company_id");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "company_logos_asset_uq" ON "company_logos" USING btree ("asset_id");
